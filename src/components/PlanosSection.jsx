    ...
    <div className="animate-rise space-y-5">
        ...
        {(config.planos || []).map((item) => (
          ...
          >
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="shrink-0 text-sm font-extrabold text-amber-300 font-mono">{item.valor}</span>
            </div>
      ...
      <div className="rounded-2xl border-2 border-amber-500/40 bg-gradient-to-br from-purple-950 via-purple-900 to-[#07040d] p-6 text-center shadow-2xl glow-mystic-strong space-y-4">
        <div className="space-y-1">
          ...
          <p className="text-xs text-amber-400/80 font-medium">Mão de obra 100% gratuita • Início imediato após o pagamento</p>
        </div>
        ...
        >
          {config.planosCta || 'PAGAR MATERIAIS NA PLATAFORMA (R$ 60,00)'}
        </button>
